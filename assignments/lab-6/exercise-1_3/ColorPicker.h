...
public:
    ColorPicker(){
        ...
        rPlusButton = Rectangle(-0.7f, -0.95f, 0.1f, 0.05f, Color(0.9f, 0.2f, 0.2f));
        gPlusButton = Rectangle(-0.5f, -0.95f, 0.1f, 0.05f, Color(0.2f, 0.9f, 0.2f));
        bPlusButton = Rectangle(-0.3f, -0.95f, 0.1f, 0.05f, Color(0.2f, 0.2f, 0.9f));

        rMinusButton = Rectangle(-0.7f, -0.85f, 0.1f, 0.05f, Color(0.7f, 0.1f, 0.1f));
        gMinusButton = Rectangle(-0.5f, -0.85f, 0.1f, 0.05f, Color(0.1f, 0.7f, 0.1f));
        bMinusButton = Rectangle(-0.3f, -0.85f, 0.1f, 0.05f, Color(0.1f, 0.1f, 0.7f));

        colorDisplay = Rectangle(-0.1f, -0.85f, 0.2f, 0.15f, currentColor);
    } //
    ...
    void adjustColor(float rDelta, float gDelta, float bDelta) {
        ...
        currentColor.setColor(newR, newG, newB);
