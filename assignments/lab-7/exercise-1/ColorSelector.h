...
struct ColorSelector{
    ...
    ColorSelector(){
        area = Rectangle(-0.6, -0.6, 1.8, 0.4, Color(0.8,0.8,0.8));
        redButton = Rectangle(-0., -0.8, 0.2, 0.2, Color(1,0,0));
        greenButton = Rectangle(-0.4, -0.8, 0.2, 0.2, Color(0,1,0));
        blueButton = Rectangle(-0.2, -0.8, 0.2, 0.2, Color(0,0,1));
