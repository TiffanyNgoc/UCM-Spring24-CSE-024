...
struct PaintApp {
    ...
    PaintApp() {
        ...
        orangeButton = Rectangle(-0.4f, -0.8f, 0.2f, 0.2f, Color(1.0f, 0.5f, 0.0f));
        yellowButton = Rectangle(-0.2f, -0.8f, 0.2f, 0.2f, Color(1.0f, 1.0f, 0.0f));
        greenButton = Rectangle(-0.0f, -0.8f, 0.2f, 0.2f, Color(0.0f, 1.0f, 0.0f));
        blueButton = Rectangle(0.2f, -0.8f, 0.2f, 0.2f, Color(0.0f, 0.0f, 1.0f));
        purpleButton = Rectangle(0.4f, -0.8f, 0.2f, 0.2f, Color(0.6f, 0.0f, 1.0f));
        ...
        circleButton = Button("Cir", -1.0f, 0.2f);
